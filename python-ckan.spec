...
Summary: CKAN Software
Requires: python3
Requires: python3-alembic >= 1.13.2
Requires: python3-babel >= 2.15.0
Requires: python3-bleach >= 6.1.0
Requires: python3-blinker >= 1.8.2
Requires: python3-certifi >= 2024.7.4
Requires: python3-click >= 8.1.7
...
Requires: python3-flask-wtf >= 1.2.1
Requires: python3-jinja2 >= 3.1.6
Requires: python3-legacy-cgi
Requires: python3-markdown >= 3.6
...
Requires: python3-pyjwt >= 2.8.0
Requires: python3-pyparsing >= 3.1.2
Requires: python3-pysolr >= 3.9.0
...
Requires: python3-rq >= 1.16.2
Requires: python3-simplejson >= 3.19.2
Requires: python3-sqlalchemy >= 1.4.52
Requires: python3-sqlparse >= 0.5.0
Requires: python3-typing-extensions >= 4.12.2
Requires: python3-tzlocal >= 5.2
Requires: python3-webassets >= 2.0
Requires: python3-werkzeug >= 3.0.6
Requires: python3-zope.interface >= 6.4post2
